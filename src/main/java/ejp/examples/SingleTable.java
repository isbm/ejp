...
public class SingleTable 
  {
    public static void main(String[] args) throws DatabaseException
      {
        ...
        dbm.saveObject(new Support("alincoln", "mypasswd1", "Abraham", "Lincoln", "United States", "alincoln@unitedstates.gov",
                                             "Request", "New", "no phone", "Can I have my bust on a penny, please."));

        dbm.saveObject(new Support("tjefferson", "mypasswd2", "Thomas", "Jefferson", "United States", "tjefferson@unitedstates.gov",
                                             "Request", "New", "no phone", "Can I have my bust on a nickel, please."));

        Collection<Support> support = dbm.loadObjects(new ArrayList<Support>(), Support.class);
    ...
    public static class CustomerSupport
      {
        ...
        public CustomerSupport(String customerId, String password, String firstName, String lastName, String companyName, String email)
          {
    ...
    public static class Support extends CustomerSupport
      {
        private String code, status, request, phone;

        public Support() {}
        
        public Support(String customerId, String password, String firstName, String lastName, String companyName,
